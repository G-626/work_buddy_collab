...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
  ...
  .ascii { position: absolute; top: -12mm; left: -12mm; z-index: 0;
           ...
           letter-spacing: 0; white-space: pre; color: #6f6759;
...
<section class="slide title">
  ...
  <div class="inner">
    ...
    <div class="content">
      ...
      <div class="titlenote">Verified in the real WorkBuddy app · 2026-08-13 · demo data is fictional</div>
    </div>
    <footer class="foot">
      <span class="fleft">CaseCraft — Agent Creativity Hackathon 2026</span>
      <span class="fright">2026-08-13</span>
    </footer>
  </div>
</section>
...
<section class="slide">
  ...
  <div class="inner">
    ...
    <div class="content">
      ...
      <p class="sub">A WorkBuddy agent runs the <span class="strong">casecraft skill</span> end to end from a capture package — transcript plus observables. Both entry points (<code>/session</code> and <code>/casecraft</code>) live in the one skill.</p>
      <div class="grid2" style="margin-top:2mm">
...
<section class="slide">
  ...
  <div class="inner">
    ...
    <div class="content">
      ...
      <div>
        <span class="badge"><span class="dot"></span>Verified · 2026-08-13</span>
        <span class="badge">WorkBuddy v4.10.4</span>
      </div>
      <p class="sub" style="margin-top:3mm">One combined skill imported through the app's native skill store. A task invoking <code>/session</code> for Marco's bakery session ran to completion, and the full artifact chain landed in the session folder.</p>
      <div class="console" style="margin-top:4mm"><span class="c-chalk">$</span> skills install ·&nbsp;&nbsp;<span class="c-green">INSTALLED → 9</span><br>
        <span class="c-gold">casecraft</span>  One skill, whole loop — /session (capture→passport) + /casecraft (pack) commands<br><br>
...
<section class="slide">
  ...
  <div class="inner">
    ...
    <div class="content">
      ...
      <p style="margin-top:7mm"><span class="strong">Today, verified:</span> the Level-1 engine (deterministic dry-run, 6/6 checks) and the Level-2 in-app run — both green on 2026-08-13. The skills are uploadable to the portal as-is.</p>
      <div class="btnrow">
